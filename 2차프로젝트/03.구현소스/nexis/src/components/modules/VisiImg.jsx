export function VisiImg(props){
	...
	<div class="sv active">
		...
		<div class="sv_txt">
			<div class="sub_tit">
				<p class="text_up">
					<span>
						<img src="/img/test/title_txt.png" alt="" />
						B2B sales
					</span>
				</p>
			</div>
	...
	<div class="sub_cont">
		<div class="top_group content active">
			<div class="inner">
				<div class="round">
					<dl>
						<dt>
							<img src="/img/main/logo_nexis.gif" alt="" />
						</dt>
						<dd>
							<em>Nex</em>t built
							<em>i</em>n
					...
					<img src="/img/main/rotate.png" alt="" />
				</div>
				<div class="tit_group">
						...
						<div class="tab active">
							<ul>
								<li class="on">
									<a href="/sub/business/b2b.asp">Domestic B2B sales</a>
								</li>
								<li>
									<a href="/sub/business/imp.asp">Import Business</a>
								</li>
								<li>
									<a href="/sub/business/orn.asp">Wall bed ORN</a>
								</li>
							</ul>
						</div>
				</div>
		...
		<div class="cont_bx">
			<div class="content quality active">
				<div class="bx_img">
					<em></em>
					<p></p>
				</div>
				<div class="bx_txt inner cf">
					<div class="txt_big">
						<p class=" text_op left">
							<span>Quality</span>
						</p>
						<p class="text_img">
...
<g>
	<path class="st0" d="M91.08,5.44v25.2h-56.7V60.7h49.14v25.2H34.38v52.02H8.28V5.44H91.08z" style="stroke-dashoffset: 0px;"></path>
	<path class="st0" d="M115.83,22.27c2.82-2.46,6.03-3.69,9.63-3.69c3.48,0,6.6,1.23,9.36,3.69s4.14,5.49,4.14,9.09s-1.38,6.6-4.14,9
	...
	<path class="st0" d="M196.83,65.92c3.78-3.36,7.65-5.97,11.61-7.83s7.08-2.79,9.36-2.79l-1.26,25.2c-0.72-0.12-1.74-0.18-3.06-0.18
	...
	<path class="st0" d="M244.44,136.12c-5.64-2.28-10.32-5.46-14.04-9.54l10.44-13.86c6.96,6.48,13.5,9.72,19.62,9.72
	...
	<path class="st0" d="M350.09,24.7v34.2h19.08v19.62h-19.08v59.4h-25.2v-59.4h-12.24V58.9h12.24V24.7H350.09z" style="stroke-dashoffset: 0px;"></path>
</g>
</svg> */}
					...
					<div class="txt_cont">
						<p class="title"><span>Domestic Edition</span></p>
						<p class="txt">
							보이지 않는 곳까지 완벽을 추구하는 품질 제일주의를 바탕으로 <br />대단위 공동주택, 호텔, 리조트 등에 주방 및 수납 가구를 납품하고 있습니다.
						</p>
					</div>
			...
			<div class="content service right active">
				<div class="bx_img">
					<p></p>
				</div>
				<div class="bx_txt inner cf">
					...
					<div class="txt_big">
						<p class="text_op right"><span>Best</span></p>
						<p class="text_img">
...
<g>
	<path class="st0" d="M63.77,28.03c-5.76,0-10.23,1.14-13.41,3.42s-4.77,5.7-4.77,10.26c0,4.2,2.31,7.89,6.93,11.07
	...
	<path class="st0" d="M178.79,113.53l11.16,18.72c-4.32,2.4-8.88,4.32-13.68,5.76c-4.8,1.44-9.36,2.16-13.68,2.16
	...
	<path class="st0" d="M257,66.01c3.78-3.36,7.65-5.97,11.61-7.83c3.96-1.86,7.08-2.79,9.36-2.79l-1.26,25.2
	...
	<path class="st0" d="M378.59,59.35l-44.64,80.28h-0.72l-47.16-80.28h29.88l18.36,37.44l16.2-37.44H378.59z" style="stroke-dashoffset: 0px;"></path>
	<path class="st0" d="M397.04,22.36c2.82-2.46,6.03-3.69,9.63-3.69c3.48,0,6.6,1.23,9.36,3.69s4.14,5.49,4.14,9.09s-1.38,6.6-4.14,9
	...
	<path class="st0" d="M498.2,137.65c-5.22,1.68-10.35,2.52-15.39,2.52c-13.68,0-24.51-3.69-32.49-11.07
	...
	<path class="st0" d="M585.59,113.53l11.16,18.72c-4.32,2.4-8.88,4.32-13.68,5.76c-4.8,1.44-9.36,2.16-13.68,2.16
		...
		c-3.36,3.84-5.04,9-5.04,15.48v1.62l34.56-11.7c-2.52-7.44-7.86-11.16-16.02-11.16C562.3,75.19,557.8,77.11,554.44,80.95z" style="stroke-dashoffset: 0px;"></path>
					...
					<div class="txt_cont">
						<p class="title">Pursuit of Perfection</p>
						<p class="txt">
							건설사와 시행사의 요구를 바탕으로 최적의 설계, 최고의 품질, 완벽한 시공과 AS를 약속합니다.
						</p>
						
						<p class="btn_area">
							<a href="/file/2019넥시스_국내프로젝트자료.pdf" target="_blank" class="btn_s1"><span>모델하우스 현황</span></a>
						</p> 
